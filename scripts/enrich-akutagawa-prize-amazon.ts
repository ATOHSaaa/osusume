/**
 * 芥川賞受賞作を Amazon Creators API で照合し JSON にリンクを付与する。
 * 実行: npx tsx scripts/enrich-akutagawa-prize-amazon.ts
 */
...
const DATA_PATH = resolve('src/data/akutagawa-prize.json');
